...
export function renderStorageRecovery(container, error, { retry, backHref = "index.html", backLabel = "Return home", scope = "library" } = {}) {
  const recovery = describeStorageRecovery(error, { scope });
