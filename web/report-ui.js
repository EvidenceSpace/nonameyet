...
function report() {
  return buildCaseReport({ ...data, options: options() });
}
...
dialog.querySelector("#download-report").onclick = () => {
  downloadCaseReport(report());
  dialog.close();
};
