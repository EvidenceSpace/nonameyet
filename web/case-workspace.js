...
function syncRenderedFileSnapshots(currentFiles = []) {
  ...
  for (const file of currentFiles) {
    ...
    try { renderedFileSnapshots.set(file.id, structuredClone(file)); }
